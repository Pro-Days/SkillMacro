# <img src = "resource/image/icon/icon.png" width=24 height=24> 데이즈 스킬매크로 <img src = "resource/image/icon/icon.png" width=24 height=24>
...
이 프로젝트는 MIT 라이센스로 라이센스가 부여되어 있습니다. 자세한 내용은 [LICENSE](license) 파일을 참고해주세요.