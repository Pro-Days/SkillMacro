...
POWER_METRIC_LABELS: dict[PowerMetric, str] = {
    ...
    PowerMetric.SKILL_CYCLE_DAMAGE_CHECK: "스킬 한사이클 일반 데미지 기댓값",
    PowerMetric.SKILL_CYCLE_BOSS_DAMAGE_CHECK: "스킬 한사이클 보스 데미지 기댓값",
    PowerMetric.SKILL_CYCLE_TARGET_DAMAGE_CHECK: "타겟 수 반영 스킬 한사이클 일반 데미지 기댓값",
